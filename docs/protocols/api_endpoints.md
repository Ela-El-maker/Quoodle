...
- Laravel -> FastAPI: POST /api/v1/command/dispatch, /policy/push, /update/deploy, /webhook/device/paired
- FastAPI -> Laravel: POST /api/v1/webhook/device/online, /device/offline, /device/activated, /command/result, /command/ack, /telemetry/summary, /security/attestation
