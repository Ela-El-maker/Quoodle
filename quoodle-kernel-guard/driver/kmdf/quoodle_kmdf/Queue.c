...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, quoodlekmdfQueueInitialize)
#endif

NTSTATUS
quoodlekmdfQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = quoodlekmdfEvtIoDeviceControl;
    queueConfig.EvtIoStop = quoodlekmdfEvtIoStop;
