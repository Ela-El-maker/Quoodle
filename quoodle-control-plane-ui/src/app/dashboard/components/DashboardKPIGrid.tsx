...
export default function DashboardKPIGrid({ data }: DashboardKPIGridProps) {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 2xl:grid-cols-4 gap-4">
      {/* Hero: Fleet Online Rate — spans 2 cols */}
      <Link
      ...
      >
        ...
        <p className="text-[11px] text-muted-foreground mt-2">+3 this week</p>
      </Link>
      {/* Compliance Drift */}
      <Link
        href="/compliance"
      ...
      <div className="group bg-card border border-border rounded-lg p-5">
        ...
        <p className="text-[11px] text-green-400 mt-2">↓ 4.2 from yesterday</p>
      </div>
    </div>
  );
}
