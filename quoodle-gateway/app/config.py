...
class Settings(BaseModel):
    ...
    require_laravel_signature: bool = os.getenv("REQUIRE_LARAVEL_SIGNATURE", "true").lower() in ("1", "true", "yes")
    ...
    sign_laravel_webhooks: bool = os.getenv("SIGN_LARAVEL_WEBHOOKS", "true").lower() in ("1", "true", "yes")
